...
[Cognition](https://www.cognition.ai/) with [Devin](https://devin.ai) is the clearest example for me.
...
Now my favorite by far is [Devin](https://devin.ai), just because of how mature the computer use functionality is.

They've been betting on this paradigm since 2023, so they're massively ahead.

### Other

[Claude Cowork](https://claude.com/product/cowork), you can kind of say, lets you delegate tasks for anything from coding to finance, etc., and let it handle them end to end.
